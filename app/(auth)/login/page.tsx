    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-0)', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <div style={{ fontSize: '13px', color: 'var(--text-2)', marginTop: '4px' }}>Sign in to your Life OS</div>
        </div>
        ...
        <div style={{ background: 'var(--bg-1)', border: '1px solid var(--border-md)', borderRadius: '16px', padding: '28px' }}>
          {magicSent ? (
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <div style={{ fontSize: '13px', color: 'var(--text-2)', lineHeight: 1.5 }}>We sent a magic link to <strong style={{ color: 'var(--text-1)' }}>{email}</strong></div>
            </div>
          ) : (
            <>
              {/* Google */}
